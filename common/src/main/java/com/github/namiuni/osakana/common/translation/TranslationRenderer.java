...
import com.github.namiuni.osakana.common.integration.MiniPlaceholdersExpansion;
...
@NullMarked
final class TranslationRenderer implements IMessageRenderer<Audience, String, Component, Component> {

    private final MiniMessage miniMessage;

    @Inject
    private TranslationRenderer() {
        this.miniMessage = TranslationRenderer.customMiniMessage();
    }
    ...
    public Component render(
        ...
        for (final Map.Entry<String, ? extends Component> entry : resolvedPlaceholders.entrySet()) {
            @Subst("translation-key") final String key = entry.getKey();
    ...
    private static MiniMessage customMiniMessage() {
