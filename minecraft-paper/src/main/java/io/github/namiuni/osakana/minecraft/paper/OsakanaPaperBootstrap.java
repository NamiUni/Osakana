...
import io.github.namiuni.osakana.configuration.GuiceConfigurationModule;
import io.github.namiuni.osakana.minecraft.paper.commands.OsakanaCommand;
import io.github.namiuni.osakana.translation.GuiceTranslationModule;
import io.github.namiuni.osakana.user.GuiceUserModule;
...
public final class OsakanaPaperBootstrap implements PluginBootstrap {
    ...
    public void bootstrap(final BootstrapContext context) {
        this.injector = Guice.createInjector(
                new GuiceOsakanaModule(context),
                new GuiceConfigurationModule(),
                new GuiceTranslationModule(),
                new GuiceUserModule()
        );

        // Initialize service logic
        this.injector.getInstance(OsakanaServiceLifecycleManager.class).startup();
